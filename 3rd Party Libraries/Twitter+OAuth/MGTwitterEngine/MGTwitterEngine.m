...
#define MAX_MESSAGE_LENGTH      250 // Twitter recommends tweets of max 140 chars
...
- (void)connection:(MGTwitterHTTPURLConnection *)connection didReceiveData:(NSData *)data
{
    ...
    NSLog(@"MGTwitterEngine: Succeeded! Received %d bytes of data:\r\r%@", [data length], dataString);
}
